package com.github.saeem.ecommerce.api.controller;

import com.github.saeem.ecommerce.api.assembler.CategoryResourceAssembler;
import com.github.saeem.ecommerce.api.assembler.ProductResourceAssembler;
import com.github.saeem.ecommerce.entity.Category;
import com.github.saeem.ecommerce.entity.Product;
import com.github.saeem.ecommerce.entity.User;
import com.github.saeem.ecommerce.security.JWTAuthenticationFilter;
import com.github.saeem.ecommerce.service.ProductService;
import com.github.saeem.ecommerce.service.SecurityService;
...
public class ProductControllerTest {
    ...
    public void testRetrieveAllProducts() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(URL))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.productResourceList[0].owner", Matchers.is("saeem")))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.productResourceList[1].owner", Matchers.is("saeem")))
    ...
    public void testRetrieveProduct() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(URL + "/{productid}", "10"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.owner", Matchers.is("saeem")))
